...
Unser Prozess beginnt bei der Entscheidung "Aktion wählen". An diesem Punkt gibt es im Gesamtsystem eigentlich vier Möglichkeiten, wie man auch in unserem vorherigen Mermaid erkennen kann: Inventar verwalten, Protokoll ansehen, Schloss verriegeln und Profile verwalten. Um unser aktuelles Diagramm übersichtlich zu halten, haben wir die anderen drei Optionen hier ausgeblendet und konzentrieren uns ausschließlich auf den Pfad der Profilverwaltung.
